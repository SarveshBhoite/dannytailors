      ...
      <div className="max-w-[1224px] mx-auto px-6 lg:px-0">
        ...
        <div className="relative w-full h-[300px] md:h-[450px] mb-12 rounded-[20px] overflow-hidden group">
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-10">
                {/* HERO SHOP NOW BUTTON (Matches Figma) */}
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <main className="flex-1 w-full">
            ...
            {/* PRODUCT GRID: Dashed Border per card + Complex Buy Now Button */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {products.map((product) => (
                // Using border properties from CSS: border-right dashed, etc.
                // We apply border-b and border-r to create the grid lines.
                <div 
                  key={product.id} 
                  className="
                    flex flex-col 
                    ...
                    p-[23px] 
                    gap-[23px]
                    border-b border-dashed border-[#212F52] 
                    border-r md:nth-2:border-r-0 lg:nth-3:border-r-0
                    border-width-[1.53px]
                  "
                  style={{ borderRightWidth: '1.53px', borderBottomWidth: '1.53px' }}
                >
                  ...
                  <div className="flex flex-col gap-[15px]">
                    ...
                    <div className="flex justify-between items-center h-[48px]">
                        ...
                        {/* Buy Now Button (Replicated from Hero style as requested) */}
